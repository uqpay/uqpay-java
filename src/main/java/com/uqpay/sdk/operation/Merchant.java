...
public class Merchant {
  ...
  public final BaseAppgateResult register(MerchantRegisterDTO registerDTO) throws UqpayRSAException, UqpayResultVerifyException, IOException {
  ...
  public final MerchantInfoResult detail(BaseJsonRequestDTO requestDTO) throws UqpayRSAException, UqpayResultVerifyException, IOException {
  ...
  public final MerchantListResult list(PageRequestDTO requestDTO) throws UqpayRSAException, UqpayResultVerifyException, IOException {
  ...
  public final BaseAppgateResult withdraw(WithdrawDTO withdrawDTO) throws UqpayRSAException, UqpayResultVerifyException, IOException {
  ...
  public final BalanceResult queryBalance(BaseJsonRequestDTO requestDTO) throws UqpayRSAException, UqpayResultVerifyException, IOException {
